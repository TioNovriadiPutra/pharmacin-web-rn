...
export const obatKategoriData = {
  headerData: ["ID", "Nama Kategori", "Tindakan"],
  tableData: [],
};
...
export const dokterPasienData = {
  headerData: ["Nama Pasien", "No. Registrasi", "No. RM", "Tgl. Periksa", "Tindakan"],
  tableData: [],
};

export const manajemenAdministratorData = {
  headerData: ["Email", "Nama", "Jenis Kelamin", "Handphone", "Alamat", "Tindakan"],
  tableData: [],
};
...
export const manajemenDokterData = {
  headerData: ["Email", "Nama Dokter", "Jenis Kelamin", "Handphone", "Spesialisasi", "Alamat", "Tindakan"],
  tableData: [],
};

export const manajemenAsistenDokterData = {
  headerData: ["Email", "Nama Asisten", "Jenis Kelamin", "Handphone", "Dokter", "Alamat", "Tindakan"],
  tableData: [],
};

export const manajemenTindakanData = {
  headerData: ["Nama Tindakan", "Harga Tindakan", "Tindakan"],
  tableData: [],
};
